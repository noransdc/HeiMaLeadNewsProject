...
<div id="app">
    ...
    <div class="article">
        ...
        <van-row type="flex" align="center" class="article-header">
            ...
            <van-col span="5">
                <van-button
                        round
                        :icon="relation.isfollow ? '' : 'plus'"
                        type="info"
                        class="article-focus"
                        :text="relation.isfollow ? '取消关注' : '关注'"
                ...
                <#list content as item>
                    ...
                    <#else>
                        <van-col span="24" class="article-image">
                            <van-image width="100%" fit="cover" src="${item.value}"></van-image>
                        </van-col>
                    </#if>
                </#list>
            </#if>
        ...
        <van-row type="flex" justify="center" class="article-action">
            <van-col>
                <van-button
                        ...
                        class="article-like"
                        :loading="likeLoading"
                        @click="handleClickArticleLike"
                >
                    <van-icon :name="relation.islike ? 'good-job' : 'good-job-o'" />
                    {{ relation.islike ? '取消赞' : '点赞' }}
                </van-button>

                <van-button
                        round
                        class="article-unlike"
                        :loading="unlikeLoading"
                        @click="handleClickArticleUnlike"
                >
                    <van-icon :name="relation.isunlike ? 'delete' : 'delete-o'" />
                    不喜欢
                </van-button>
            </van-col>
        </van-row>
                    ...
                    <van-row type="flex" align="center" justify="space-between">
                        ...
                        <van-col>
                            <van-button
                                    ...
                                    @click="handleClickCommentLike(item)"
                            >
                                {{ item.likes || '' }}
                            </van-button>
                        </van-col>
                    ...
                    <van-row type="flex" align="center">
                        ...
                        <van-col span="3">
                            <van-button
                                    round
                                    size="normal"
                                    @click="showCommentRepliesPopup(item.id)"
                            >
                                回复 {{ item.reply || '' }}
                            </van-button>
                        </van-col>
    ...
    <van-row type="flex" justify="space-around" align="center" class="article-bottom-bar">
        ...
        <van-col span="3">
            <van-button
                    :icon="relation.iscollection ? 'star' : 'star-o'"
                    :loading="collectionLoading"
                    @click="handleClickArticleCollection"
            ></van-button>
        </van-col>
        <van-col span="3">
    ...
    <!-- 评论回复 Popup -->
    <van-popup v-model="showPopup" closeable position="bottom" :style="{ height: '60%' }">
        ...
        <van-row type="flex" justify="space-around" align="center" class="comment-reply-bottom-bar">
            ...
            <van-col span="3"><van-button icon="comment-o"></van-button></van-col>
            <van-col span="3"><van-button icon="star-o"></van-button></van-col>
            <van-col span="3"><van-button icon="share-o"></van-button></van-col>
        </van-row>
